...
export declare class Group extends Discuss {
    ...
    /** 群文件系统 */
    readonly fs: Gfs;
    protected constructor(c: Client, gid: number, _info?: GroupInfo);
    /** 获取一枚群员实例 */
    pickMember(uid: number, strict?: boolean): any;
    ...
    setAdmin(uid: number, yes?: boolean): any;
    setTitle(uid: number, title?: string, duration?: number): any;
    setCard(uid: number, card?: string): any;
    kickMember(uid: number, block?: boolean): any;
    muteMember(uid: number, duration?: number): any;
    pokeMember(uid: number): any;
}
export {};
