...
export declare class Client extends BaseClient {
     ...
     */
    readonly pickGroup: any;
    /** 得到一个好友对象, 通常不会重复创建 */
    readonly pickFriend: any;
    /** 得到一个群员对象, 通常不会重复创建 */
    readonly pickMember: any;
    /** 创建一个用户对象 */
    readonly pickUser: any;
    /** 创建一个讨论组对象 */
    readonly pickDiscuss: any;
    ...
    /** 设置在线状态 */
    setOnlineStatus(status?: OnlineStatus): any;
    /** 设置昵称 */
    ...
    /** 设置头像 */
    setAvatar(file: ImageElem["file"]): Promise<any>;
    /** 获取漫游表情 */
    getRoamingStamp(no_cache?: boolean): any;
    /** 删除表情(支持批量) */
    deleteStamp(id: string | string[]): any;
    /** 获取系统消息 */
    getSystemMsg(): any;
    /** 添加好友分组 */
    ...
    /** 重命名好友分组 */
    renameClass(id: number, name: string): any;
    /** 重载好友列表 */
    reloadFriendList(): any;
    /** 重载陌生人列表 */
    reloadStrangerList(): any;
    /** 重载群列表 */
    reloadGroupList(): any;
    /** 重载黑名单 */
    reloadBlackList(): any;
    ...
    cleanCache(): void;
    /** 获取视频下载地址 */
    getVideoUrl(fid: string, md5: string | Buffer): any;
    /** 获取转发消息 */
    getForwardMsg(resid: string, fileName?: string): any;
    /** 制作转发消息 */
    makeForwardMsg(fake: Forwardable[], dm?: boolean): any;
    /** Ocr图片转文字 */
    imageOcr(file: ImageElem["file"]): any;
    ...
    getGroupInfo(group_id: number, no_cache?: boolean): Promise<any>;
    /** @cqhttp use group.getMemberList() */
    getGroupMemberList(group_id: number, no_cache?: boolean): Promise<any>;
    ...
    sendPrivateMsg(user_id: number, message: Sendable, source?: Quotable): Promise<any>;
    /** @cqhttp use group.sendMsg() */
    sendGroupMsg(group_id: number, message: Sendable, source?: Quotable): Promise<any>;
    /** @cqhttp use discuss.sendMsg() */
    sendDiscussMsg(discuss_id: number, message: Sendable, source?: Quotable): Promise<any>;
    /** @cqhttp use member.sendMsg() */
    sendTempMsg(group_id: number, user_id: number, message: Sendable): Promise<any>;
    /** @cqhttp use user.recallMsg() or group.recallMsg() */
    deleteMsg(message_id: string): Promise<any>;
    /** @cqhttp use user.markRead() or group.markRead() */
    reportReaded(message_id: string): Promise<any>;
    /** @cqhttp use user.getChatHistory() or group.getChatHistory() */
    getMsg(message_id: string): Promise<any>;
    /** @cqhttp use user.getChatHistory() or group.getChatHistory() */
    getChatHistory(message_id: string, count?: number): Promise<any>;
    /** @cqhttp use group.muteAnony() */
    setGroupAnonymousBan(group_id: number, flag: string, duration?: number): Promise<any>;
    /** @cqhttp use group.allowAnony() */
    setGroupAnonymous(group_id: number, enable?: boolean): Promise<any>;
    /** @cqhttp use group.muteAll() */
    setGroupWholeBan(group_id: number, enable?: boolean): Promise<any>;
    /** @cqhttp use group.setName() */
    setGroupName(group_id: number, name: string): Promise<any>;
    /** @cqhttp use group.announce() */
    sendGroupNotice(group_id: number, content: string): Promise<any>;
    /** @cqhttp use group.setAdmin() or member.setAdmin() */
    setGroupAdmin(group_id: number, user_id: number, enable?: boolean): Promise<any>;
    /** @cqhttp use group.setSpecialTitle() or member.setSpecialTitle() */
    setGroupSpecialTitle(group_id: number, user_id: number, special_title: string, duration?: number): Promise<any>;
    /** @cqhttp use group.setCard() or member.setCard() */
    setGroupCard(group_id: number, user_id: number, card: string): Promise<any>;
    /** @cqhttp use group.kickMember() or member.kick() */
    setGroupKick(group_id: number, user_id: number, reject_add_request?: boolean): Promise<any>;
    /** @cqhttp use group.muteMember() or member.mute() */
    setGroupBan(group_id: number, user_id: number, duration?: number): Promise<any>;
    /** @cqhttp use group.quit() */
    setGroupLeave(group_id: number): Promise<any>;
    /** @cqhttp use group.pokeMember() or member.poke() */
    sendGroupPoke(group_id: number, user_id: number): Promise<any>;
    /** @cqhttp use member.addFriend() */
    addFriend(group_id: number, user_id: number, comment?: string): Promise<any>;
    /** @cqhttp use friend.delete() */
    deleteFriend(user_id: number, block?: boolean): Promise<any>;
    /** @cqhttp use group.invite() */
    inviteFriend(group_id: number, user_id: number): Promise<any>;
    /** @cqhttp use friend.thumbUp() */
    sendLike(user_id: number, times?: number): Promise<any>;
    /** @cqhttp user client.setAvatar() */
    setPortrait(file: Parameters<Client["setAvatar"]>[0]): Promise<any>;
    /** @cqhttp use group.setAvatar() */
    setGroupPortrait(group_id: number, file: Parameters<Group["setAvatar"]>[0]): Promise<any>;
    /** @cqhttp use group.fs */
    acquireGfs(group_id: number): any;
    /** @cqhttp use user.setFriendReq() or user.addFriendBack() */
    setFriendAddRequest(flag: string, approve?: boolean, remark?: string, block?: boolean): Promise<any>;
    /** @cqhttp use user.setGroupInvite() or user.setGroupReq() */
    setGroupAddRequest(flag: string, approve?: boolean, reason?: string, block?: boolean): Promise<any>;
